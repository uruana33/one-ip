...
const definitions = new Map([
  ...
  [
    t("IP 原生性"),
    t(
      "仅比较注册国家与定位国家是否一致，不能证明真实接入线路或是否代理；国家不同也可能来自跨境运营或数据库差异。",
    ),
  ],
  [
    t("ASN 自报类型"),
  ...
  [
    t("网段"),
    t(
      "注册局对覆盖网段的登记日，不是宽带开户、设备启用或首次上网日期，不参与信誉评分。",
    ),
  ],
  [
    t("代理"),
  ...
  [t("本站信誉参考分"), t("按已读维度估算，未返回的字段保持未知")],
  [
    t("IP 信誉分"),
    t(
      "Net.Coffee 的 0–100 信誉只是本站参考指数的一家输入，不能当成全网纯净度。",
    ),
  ],
  [
    t("Net.Coffee 信誉"),
