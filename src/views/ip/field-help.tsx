...
const definitions = new Map([
  ...
  [
    t("网段"),
    t(
      "注册局对当前覆盖网段的登记日，不是宽带开户、设备启用或这个地址第一次上网的日期。较新的住宅或 ISP 网段最多给质量分 +8；机房、代理和滥用不加分。",
    ),
  ],
  [
    t("代理"),
  ...
  [
    t("质量分"),
    t(
      "0–100，越高越好。由已读取来源按信誉、匿名、用途三维公式计算；IPQS 与 AbuseIPDB 只外链、不计分。不是把各家原始分数直接平均。",
    ),
  ],
  [
    t("IP 信誉分"),
    t(
      "现已改用顶部质量分。Net.Coffee 的 0–100 信誉只是其中一家输入，不能当成全网纯净度。",
    ),
  ],
  [
    t("Net.Coffee 信誉"),
    t(
      "Net.Coffee 给出的 0–100 信誉，越高风险越低。只代表这一家，不能当成全网纯净度，也不能代表任何平台的官方判定。",
    ),
  ],
]);
