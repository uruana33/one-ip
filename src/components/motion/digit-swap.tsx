/** Adapted from beUI (MIT) — https://beui.dev/components/motion/number */
"use client";
        ...
        {glyphs.map(({ character, id, position }) => {
          ...
          return (
            <span
              ...
              className="relative inline-block h-[1.1em] shrink-0 overflow-hidden align-bottom"
            >
              <span className="invisible inline-block leading-none">
                {character}
              </span>
